      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-12 flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/sign-in">
              <Button className="h-14 px-8 text-lg bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full border-0 shadow-lg cursor-pointer tracking-wide font-medium">
                Get Started
              </Button>
            </Link>
            <Link href="#demo">
              <Button variant="outline" className="h-14 px-8 text-lg rounded-full shadow-lg dark:text-white dark:border-white/20 dark:bg-black/50 backdrop-blur-md cursor-pointer tracking-wide font-medium">
                Watch Demo
              </Button>
            </Link>
          </div>
