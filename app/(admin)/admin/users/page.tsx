...
import { Search, Shield, ShieldBan, MoreVertical, ActivitySquare, Loader2 } from "lucide-react";
                                    ...
                                    <tr key={user.id} className="border-b border-slate-100 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center">
                                                <div className="h-10 w-10 shrink-0 rounded-full bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/50 dark:to-purple-900/50 flex items-center justify-center font-bold text-blue-700 dark:text-blue-400 overflow-hidden">
                                                    {user.imageUrl ? <img src={user.imageUrl} alt="" className="w-full h-full object-cover" /> : user.name?.charAt(0)}
                                                </div>
                                                <div className="ml-4">
                                        ...
                                        <td className="px-6 py-4 text-right space-x-2">
                                            <Button 
                                                variant="outline" 
                                                size="sm" 
                                                className="h-8 rounded-lg bg-white dark:bg-white/5 border-slate-200 dark:border-white/10 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-500/10"
